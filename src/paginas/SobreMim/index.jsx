...
export default function SobreMim() {
    return (
        ...
        >
            ...
            <p className={styles.paragrafo}>
                 Minha saga com TI começou em 1994 quando tinha 12 anos de idade, trocando bateria de placa mãe 286 que eram soldadas, ajudando meu pai que estudava manutenção e já programava em cobol e Pascal se não me engano.
            </p>
            <p className={styles.paragrafo}>
